...
%perceptron using the MNIST dataset and evaluate its performance.
    ...
    [hiddenWeights, outputWeights, error] = train(activationFunction, dActivationFunction, Hidden_layer_nodes, inputValues, targetValues, epochs, batchSize, learningRate);
    ...
    [correctlyClassified, classificationErrors] = Predict(activationFunction, hiddenWeights, outputWeights, inputValues, labels);

    fprintf('Total test samples: %d\n', classificationErrors+correctlyClassified);
    fprintf('Mis-classify: %d\n', classificationErrors);
    fprintf('Correctly classified: %d\n', correctlyClassified);
    fprintf('Accuracy: %.2f\n', 100*correctlyClassified/10000);
end